...
* MIRU_SYSLOG_TCP_ADDR_PORT - required
...
* CHANNEL_BUFFER_SIZE_ACCUM - default to 1024
* CHANNEL_BUFFER_SIZE_POST - default to 1024
* CHANNEL_BUFFER_ACCUM_BATCH - default to 1000
* CHANNEL_BUFFER_ACCUM_DELAY_MS - default to 100
